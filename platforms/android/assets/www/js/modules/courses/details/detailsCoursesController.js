...
function detailsCoursesController ($http,$routeParams,coursesDetails,forumList,userList){
    var self = this;    
...
//    self.discussions = function(){
//        self.discussionsList = [];
//        debugger
//        forumList.save("forumids[0]=" + 13).$promise.then(function(res){
//            debugger
//        });
//    }
...
angular.module('StarterApp').controller('detailsCoursesController' , ['$http','$routeParams','coursesDetails','forumList','userList',detailsCoursesController]);